...
|-----------|------|---------|----------|-------------|
| doc-maintainer | Documentation Maintainer | 1.5.0 | productivity | Specialized agent for documentation auditing and maintenance. Supports audit mode and active maintenance modes. |
